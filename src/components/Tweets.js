...
class Emails extends Component {
    ...
    onFormSubmit = e => {
        ...
        openai.createCompletion({
            ...
            prompt: `Generate a tweet i can use to get to advertise on twitter to get more views for: ${formDataObj.Tweet}`,
            temperature: 0.7,
            max_tokens: 256,
            top_p: 1,
            frequency_penalty: 0,
            ...
            .then((response) => {
                ...
                this.setState({
                    heading: `AI Email Generator: ${formDataObj.Tweet}`,
